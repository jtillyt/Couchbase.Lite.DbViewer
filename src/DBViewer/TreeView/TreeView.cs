...
namespace DBViewer.TreeView
{
    public class TreeView : ScrollView
    {
        ...
        private static void AddItems(IEnumerable<TreeViewNode> childTreeViewItems, StackLayout parent,
            TreeViewNode parentTreeViewItem)
        {
        ...
        internal static void RenderNodes(IEnumerable<TreeViewNode> childTreeViewItems, StackLayout parent,
            NotifyCollectionChangedEventArgs e, TreeViewNode parentTreeViewItem)
        {
        ...
        public IList<TreeViewNode> RootNodes
        {
            ...
            set
            {
                ...
                RenderNodes(_RootNodes, _StackLayout,
